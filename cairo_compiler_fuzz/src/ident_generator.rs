...
const FUNCTION_PREFIX: &str = "pub fn";
...
impl IdentGenerator {
    ...
    pub fn generate_const(&mut self) -> String {
        self.generate(CONST_PREFIX)
    }

    pub fn generate_function_name(&mut self) -> String {
        self.generate(FUNCTION_PREFIX)
    }

    pub fn generate_struct_name(&mut self) -> String {
